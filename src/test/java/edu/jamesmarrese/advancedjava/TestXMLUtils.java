...
import edu.jamesmarrese.advancedjava.xml.OutputXML;
import edu.jamesmarrese.advancedjava.xml.Stocks;
import edu.jamesmarrese.advancedjava.util.XMLUtils;
...
public class TestXMLUtils {
    ...
    private static String xmlPath = "./src/main/java/resources/xml/stock_info.xml";
    ...
    public void testMarshall() throws Exception {
        ...
        OutputXML print = new OutputXML();
        print.outputXML(stocks);
